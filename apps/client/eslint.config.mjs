...
const eslintConfig = [
  ...
  {
    // Exception for Storyblok auto-generated type files
    // Allow 'any' types since these are generated by Storyblok CLI and we don't control the output
    files: ["**/types/storyblok/**/*.{ts,d.ts}"],
    rules: {
      "@typescript-eslint/no-explicit-any": "off",
      "@typescript-eslint/no-unused-vars": "off" // May have unused imports from CLI generation
    }
  }
];
